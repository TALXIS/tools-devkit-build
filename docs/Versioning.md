...
| `Connector` | Not versioned - a Dataverse `Connector` component has no version field of its own; it only ever rides the containing Solution's version, same as CodeApp |
