...
| `TalxisMergeOutputAssembly` | `true` | When `true`, runs `TalxisMergeOutputAssembly` after `Build` to ILRepack referenced DLLs into the plugin assembly. Set to `false` to opt out. |
